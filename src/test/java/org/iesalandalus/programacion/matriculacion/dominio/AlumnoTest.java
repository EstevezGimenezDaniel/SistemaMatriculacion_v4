...
public class AlumnoTest {
    ...
    private static final String NIA_NO_ESPERADO = "El c�lculo del N�mero de Identificaci�n del Alumno no es el correcto.";
    ...
    private static final String ERROR_NOMBRE_NO_VALIDO = "ERROR: El nombre de un alumno no puede estar vac�o.";
    ...
    private static final String ERROR_DNI_NO_VALIDO = "ERROR: El dni del alumno no tiene un formato v�lido.";
    ...
    private static final String ERROR_CORREO_NO_VALIDO = "ERROR: El correo del alumno no tiene un formato v�lido.";
    private static final String ERROR_TELEFONO_NO_VALIDO = "ERROR: El tel�fono del alumno no tiene un formato v�lido.";

    private static final String MENSAJE_EXCEPCION_NO_CORRECTO = "El mensaje devuelto por la excepci�n no es correcto.";
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deber�a haber creado el objeto alumno.";
    ...
    private static final String ERROR_TELEFONO_NULO = "ERROR: El tel�fono de un alumno no puede ser nulo.";
    ...
    private static final String ERROR_FECHA_NACIMIENTO_INCORRECTA = "ERROR: La edad del alumno debe ser mayor o igual a 16 a�os.";
    private static final String ALUMNO_NO_ESPERADO = "El alumno copiado deber�a ser el mismo que el pasado como par�metro.";
    private static final String ALUMNO_NULO = "Deber�a haber saltado una excepci�n indicando que no se puede copiar un alumno nulo.";
    ...
    public void toStringDevuelveLaCadenaEsperada() {
        ...
        assertEquals(String.format("N�mero de Identificaci�n del Alumnado (NIA)=%s " + "nombre=%s (%s), DNI=%s, correo=%s, tel�fono=%s, fecha nacimiento=%s",NIA_JRJR, NOMBRE_JRJR, "JRJR", DNI_JRJR, CORREO_JRJR, TELEFONO_JRJR, FECHA_NACIMIENTO_JRJR.format(DateTimeFormatter.ofPattern(FORMATO_FECHA))), alumno.toString(), CADENA_NO_ESPERADA);

        alumno = new Alumno(NOMBRE_MAL_ARDR, DNI_ARDR, CORREO_ARDR, TELEFONO_ARDR, FECHA_NACIMIENTO_ARDR);
        assertEquals(String.format("N�mero de Identificaci�n del Alumnado (NIA)=%s " + "nombre=%s (%s), DNI=%s, correo=%s, tel�fono=%s, fecha nacimiento=%s", NIA_ARDR, NOMBRE_ARDR, "ARDR", DNI_ARDR, CORREO_ARDR, TELEFONO_ARDR, FECHA_NACIMIENTO_ARDR.format(DateTimeFormatter.ofPattern(FORMATO_FECHA))), alumno.toString(), CADENA_NO_ESPERADA);
    }
