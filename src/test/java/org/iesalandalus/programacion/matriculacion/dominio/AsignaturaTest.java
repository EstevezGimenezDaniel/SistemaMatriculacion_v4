...
public class AsignaturaTest {
    ...
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deber�a haber creado el objeto asignatura.";
    private static final String MENSAJE_EXCEPCION_NO_CORRECTO = "El mensaje devuelto por la excepci�n no es correcto.";
    private static final String ERROR_CODIGO_NULO="ERROR: El c�digo de una asignatura no puede ser nulo.";
    private static final String ERROR_CODIGO_INCORRECTO="ERROR: El c�digo de una asignatura no puede estar vac�o.";
    private static final String ERROR_CODIGO_FORMATO_INCORRECTO="ERROR: El c�digo de la asignatura no tiene un formato v�lido.";
    private static final String ERROR_NOMBRE_NULO="ERROR: El nombre de una asignatura no puede ser nulo.";
    private static final String ERROR_NOMBRE_INCORRECTO="ERROR: El nombre de una asignatura no puede estar vac�o.";
    private static final String ERROR_HORAS_INCORRECTAS="ERROR: El n�mero de horas de una asignatura no puede ser menor o igual a 0 ni mayor a " + Asignatura.MAX_NUM_HORAS_ANUALES + ".";
    private static final String ERROR_CURSO_NULO="ERROR: El curso de una asignatura no puede ser nulo.";
    private static final String ERROR_HORAS_DESDOBLE_INCORRECTAS="ERROR: El n�mero de horas de desdoble de una asignatura no puede ser menor a 0 ni mayor a "+ Asignatura.MAX_NUM_HORAS_DESDOBLES+ ".";
    ...
    private static final String ASIGNATURA_NULA = "Deber�a haber saltado una excepci�n indicando que no se puede copiar una asignatura nula.";
    ...
    void toStringDevuelveLaCadenaEsperada() {
        ...
        String cadenaEsperada=String.format("C�digo=%s, nombre=%s, horas anuales=%d, curso=%s, horas desdoble=%d, ciclo formativo=%s, especialidad profesorado=%s", CODIGO_ASIGNATURA, NOMBRE_ASIGNATURA,HORAS_ASIGNATURA,
    ...
    void imprimirDevuelveLaCadenaEsperada() {
        ...
        String cadenaEsperada=String.format("C�digo asignatura=%s, nombre asignatura=%s, ciclo formativo=%s", CODIGO_ASIGNATURA, NOMBRE_ASIGNATURA, cf.imprimir());
