...
public class CicloFormativoTest {
    ...
    private static final String CODIGO_NO_ESPERADO = "El c�digo devuelto no es el mismo que el pasado al constructor.";
    ...
    private static final String CODIGO_INCORRECTO = "Deber�a haber saltado una excepci�n indicando que el c�digo es incorrecto";
    private static final String ERROR_NOMBRE_NULO = "ERROR: El nombre de un ciclo formativo no puede ser nulo.";
    private static final String ERROR_NOMBRE_NO_VALIDO = "ERROR: El nombre de un ciclo formativo no puede estar vac�o.";
    private static final String FAMILIA_PROFESIONAL_INCORRECTA = "Deber�a haber saltado una excepci�n indicando que la familia profesional es incorrecta.";
    ...
    private static final String ERROR_FAMILIA_PROFESIONAL_NO_VALIDA = "ERROR: La familia profesional no puede estar vac�a.";
    private static final String ERROR_GRADO_NULO = "ERROR: El grado de un ciclo formativo no puede ser nulo.";
    private static final String GRADO_INCORRECTO = "Deber�a haber saltado una excepci�n indicando que el grado es incorrecto";


    private static final String MENSAJE_EXCEPCION_NO_CORRECTO = "El mensaje devuelto por la excepci�n no es correcto.";
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deber�a haber creado el objeto ciclo formativo.";
    private static final String NOMBRE_INCORRECTO = "Deber�a haber saltado una excepci�n indicando que el nombre es incorrecto";

    private static final String HORAS_INCORRECTA = "Deber�a haber saltado una excepci�n indicando que las horas son incorrectas";
    private static final String ERROR_HORAS_INCORRECTA = "ERROR: El n�mero de horas de un ciclo formativo no puede ser menor o igual a 0 ni mayor a " + CicloFormativo.MAXIMO_NUMERO_HORAS + ".";
    private static final String CICLO_FORMATIVO_NO_ESPERADO = "El ciclo formativo copiado deber�a ser el mismo que el pasado como par�metro.";
    private static final String CICLO_FORMATIVO_NULO = "Deber�a haber saltado una excepci�n indicando que no se puede copiar un ciclo formativo nulo.";
    ...
    public void toStringDevuelveLaCadenaEsperada() {
        ...
        assertEquals(String.format("C�digo ciclo formativo=%d, familia profesional=%s, grado=%s, nombre ciclo formativo=%s, horas=%s",CODIGO_CF, FAMILIA_PROFESIONAL_CF, GRADO_CF, NOMBRE_CICLO_FORMATIVO, HORAS_CICLO_FORMATIVO), cf.toString(), CADENA_NO_ESPERADA);
    ...
    public void imprimirDevuelveLaCadenaEsperada() {
        ...
        assertEquals(String.format("C�digo ciclo formativo=%d, nombre ciclo formativo=%s",CODIGO_CF, NOMBRE_CICLO_FORMATIVO), cf.imprimir(), CADENA_NO_ESPERADA);
